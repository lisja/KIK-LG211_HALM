...
def search(input_query): # search the query
    ...
    #Reminder about the commands; print removed to make the output clearer
    ...
    try:
        ...
        #Remove """ if you'd like to see how the query is rewritten and the matrix
...
#This is Alex's revised code 30.1.2023
...
#This is Mikhail's original code
            
            """
            documents[doc_idx].splitlines()
